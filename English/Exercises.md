...
exercise as a starting point. For example, a GET request for number 31 is given as: `http://127.0.0.1:3000/prime_number/31`. The response must 
...
`http://127.0.0.1:3000/airport/EFHK`. The response must be in the format of: `{"ICAO":"EFHK", "Name":"Helsinki-Vantaa Airport", "Location":"Helsinki"}`.
